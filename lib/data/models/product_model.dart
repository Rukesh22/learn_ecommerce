...
class ProductModel {
  ...
  //Ceate Empty func for clean ncode
  ...
  //Map Json oriented document snapshot from firebsae to Model
  factory ProductModel.fromSnaphot(DocumentSnapshot<Map<String, dynamic>> document) {
  ...
  //Map Json oriented document snapshot from firebsae to Model
  factory ProductModel.fromQuerySnaphot(QueryDocumentSnapshot<Object?> document) {
